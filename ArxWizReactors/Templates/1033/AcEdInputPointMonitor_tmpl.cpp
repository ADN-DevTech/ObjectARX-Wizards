...
//-----------------------------------------------------------------------------
bool [!output CLASS_NAME_ROOT]::excludeFromOsnapCalculation (
	const AcArray<AcDbObjectId> &nestedEntity,
	Adesk::GsMarker gsSelectionMark
) {
	return ([!output BASE_CLASS]::excludeFromOsnapCalculation (nestedEntity, gsSelectionMark)) ;
}

//-----------------------------------------------------------------------------
Acad::ErrorStatus [!output CLASS_NAME_ROOT]::monitorInputPoint (
