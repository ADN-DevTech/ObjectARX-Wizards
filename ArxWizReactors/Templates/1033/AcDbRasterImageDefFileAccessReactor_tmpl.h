...
public:
	...
	virtual void onAttach (const AcDbRasterImageDef *unnamed, const ACHAR *pPath) ;
	virtual void onClose (const AcDbRasterImageDef *unnamed, const ACHAR *pPath) ;
	virtual void onDetach (const AcDbRasterImageDef *unnamed, const ACHAR *pPath) ;
	virtual void onDialog (AcDbRasterImageDef *unnamed, const ACHAR *pCaption, const ACHAR *pFileExtensions) ;
