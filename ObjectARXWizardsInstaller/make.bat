...
if exist ObjectARXWizards-2016.zip del ObjectARXWizards-2016.zip > nul
"C:\Program Files\WinRAR\WinRAR.exe" a ObjectARXWizards-2016.zip ObjectARXWizards.msi > nul
