...
if exist ObjectARXWizards-2015.zip del ObjectARXWizards-2015.zip > nul
"C:\Program Files\WinRAR\WinRAR.exe" a ObjectARXWizards-2015.zip ObjectARXWizards.msi > nul
